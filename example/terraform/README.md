...
| source_image | The image name for the disk for the VM instance. | `string` | `"projects/mpi-gclouds-public/global/images/gclouds-win2022-sql2022-dev-1788818451"` | no |
